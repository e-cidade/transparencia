...
?>
<div class="<?php echo $pluralVar;?> form"><?php echo "<?php echo \$this->Form->create('{$modelClass}');?>\n";?>
<fieldset><legend><?php echo "<?php printf(__('" . $actionTitulo . " %s', true), __('" . Inflexao::acentos($singularHumanName) . "', true)); ?>";?></legend>
<?php
echo "\t<?php\n";
