<div id="breadcrumb">
  <?php  
    ...
    $this->Crumb->addPage(2,'Diárias'       ,'despesas/loadDiarias') ;
  ...
  <select id="exercicioConsulta" style="width:80px;">
	...
	<fieldset>
	  ...
	  <div class="navbar_detalhe">
			<ul>
				<li><a href="#" onClick="js_loadMenu('4');">Despesas Instituição / Orgão </a></li>
        <li><a href="#" onClick="js_loadMenu('5');">Despesas por Credor / Instituição</a></li>
			</ul>
		</div>
	</fieldset>
	</div>
...
<script type="text/javascript">
  ...
  function js_loadMenu(sMenu) {
    var oParametros = new Object();
        ...
        oParametros.iElemento        =  <?php echo $aParametros['iElemento']?>;
